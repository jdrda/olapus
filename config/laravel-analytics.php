...
return
    ...
    [
         ...
         */
            'certificatePath' => storage_path('laravel-analytics/privatekey.p12'),

        /*
         * The amount of minutes the Google API responses will be cached.
         * If you set this to zero, the responses won't be cached at all.
         */
        'cacheLifetime' => env('ANALYTICS_CACHE_LIFETIME_MINUTES', 60 * 24 * 2),
         ...
         */
        'realTimeCacheLifetimeInSeconds' => env('ANALYTICS_REALTIME_CACHE_LIFETIME_SECONDS', 5),
    ];
