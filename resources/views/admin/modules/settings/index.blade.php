                ...
                <table class="table table-hover table-responsive">
                    <tbody>
                        <tr>
                            ...
                            <th class="hidden-xs">
                                 <a href="@if(Request::has('orderbycolumn') and request('orderbycolumn') == 'value' and request('orderbytype') == 'asc'){{ route($moduleBasicRoute . '.index', ['search' => request('search'), 'orderbycolumn' => 'value', 'orderbytype' => 'desc']) }}@else{{ route($moduleBasicRoute . '.index', ['search' => request('search'), 'orderbycolumn' => 'value', 'orderbytype' => 'asc']) }}@endif">
                                    {{ trans($moduleNameBlade . '.fields.value') }}
