                ...
                <table class="table table-hover table-responsive">
                    <tbody>
                        <tr>
                            ...
                            <th class="hidden-xs">
                                <a href="@if(Request::has('orderbycolumn') and request('orderbycolumn') == 'class' and request('orderbytype') == 'asc'){{ route($moduleBasicRoute . '.index', ['search' => request('search'), 'orderbycolumn' => 'class', 'orderbytype' => 'desc']) }}@else{{ route($moduleBasicRoute . '.index', ['search' => request('search'), 'orderbycolumn' => 'class', 'orderbytype' => 'asc']) }}@endif">
                                    {{ trans($moduleNameBlade . '.fields.class') }}
                                    @if(Request::has('orderbycolumn') and request('orderbycolumn') == 'class')
                                    <i class='fa fa-sort-alpha-{{ request('orderbytype') == 'asc' ? 'asc' : 'desc' }}'></i>
                                    @endif
                                </a>
                            </th>
