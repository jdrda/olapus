                ...
                <table class="table table-hover table-responsive">
                    <tbody>
                        <tr>
                            ...
                            <th class="hidden-xs">
                               {{ trans($moduleNameBlade . '.fields.advertlocation') }}
                            </th>
                            <th class="hidden-xs hidden-sm">
                                <a href="@if(Request::has('orderbycolumn') and request('orderbycolumn') == 'position' and request('orderbytype') == 'asc'){{ route('admin.user.index', ['search' => request('search'), 'orderbycolumn' => 'position', 'orderbytype' => 'desc']) }}@else{{ route($moduleBasicRoute . '.index', ['search' => request('search'), 'orderbycolumn' => 'position', 'orderbytype' => 'asc']) }}@endif">
                        ...
                        <tr>
                            ...
                            <td>{{ $result->name }}</td>
                            <td class="hidden-xs">
                                @foreach($result['advertlocations'] as $advertlocation)
                                <span class="label label-{{ $advertlocation->color }}">{{ $advertlocation->name }}</span>
                                @endforeach
                            </td>
